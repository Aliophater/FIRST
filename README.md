...
| 姓名 | 角色 | 负责模块 |
|------|------|----------|
| **沈骏龙** | 🏗️ 组长 | AI Agent 核心 + 后端架构（FastAPI 架构、LangChain Agent & Tools、LLM 多模型集成、模块协调） |
| **余致强** | 🔍 组员 | RAG 知识库系统（多格式文档解析、ChromaDB 向量存储、HyDE 混合检索、重排序模型、知识库 API） |
| **李子恩** | 🎨 组员 | 前端核心与编辑器（React 架构、Tiptap 富文本编辑器、笔记管理页面、通用组件库） |
| **贠炳鑫** | 🌐 组员 | 前端 AI 交互与国际化（AI 聊天 + SSE 流式、知识库页面、每日回顾、i18n、Zustand 状态管理） |
| **闫浩楠** | 🔐 组员 | 用户服务与数据库（Django 用户系统、JWT 认证、MySQL 表设计、Redis 缓存、Celery 异步任务） |
| **崔浩文** | 🚀 组员 | 基础设施与展示（路由守卫、登录/注册页面、Docker 部署、项目文档、答辩 PPT） |

## 联系方式

如有任何问题或建议，欢迎联系作者：

- Email: 2776893559@qq.com
- QQ: 2776893559
